...
const variantStyles: Record<CardVariant, string> = {
  glass:
    'border border-white/10 bg-[#1a1f2a]',
  solid:
    'border border-white/10 bg-[#1d222d]',
  interactive:
    'border border-white/10 bg-[#1a1f2a] hover:border-amber-500/40 hover:bg-[#1d222d] hover:-translate-y-1 transition-all duration-300',
}
