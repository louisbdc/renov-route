...
export default function SEOPricing({ 
  ...
  const structuredData = {
    ...
    "@type": "Product",
    "name": "Services de Traçage Marquage Routier",
    "description": "Services professionnels de traçage marquage routier et parking",
    "brand": {
      "@type": "Brand",
      "name": "Renov Route"
    },
      ...
      <div className={className}>
        <div className="bg-white rounded-lg shadow-md border border-gray-200 p-6">
          ...
          <div className={`grid ${getGridClass()} gap-6`}>
            {tiers.map((tier) => (
              <div key={tier.id} className={`bg-white rounded-lg shadow-md border-2 overflow-hidden ${
                ...
                <div className="p-6">
                  ...
                  {showCta && (
                    <div className="pt-4 border-t border-gray-200">
                      <Link
                        href={tier.cta.link}
                        className={`inline-flex items-center justify-center w-full px-4 py-3 rounded-lg font-medium transition-colors ${getCtaClass(tier.cta.type)}`}
                      >
                        {tier.cta.text}
