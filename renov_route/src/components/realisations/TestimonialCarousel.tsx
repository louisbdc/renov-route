  ...
  return (
    <section className={`py-16 ${className}`}>
      <div className="container-custom">
        ...
        >
          <h2 className="text-h2 text-[#0F172A] font-semibold mb-4">
            Témoignages Clients
          </h2>
          <p className="text-[#0F172A]/90 text-body-lg max-w-2xl mx-auto">
          ...
          <div className="relative overflow-hidden rounded-xl">
            <AnimatePresence mode="wait">
              <motion.div
                ...
                className="glass-panel p-8 lg:p-12 backdrop-blur-md bg-white/10 border border-slate-300"
              >
                <div className="max-w-4xl mx-auto text-center">
                  {/* Quote */}
                  <motion.blockquote
                    className="text-h3 text-[#0F172A] font-medium leading-relaxed mb-8"
                  ...
                  >
                    <div className="text-[#0F172A] font-semibold text-body-lg">
            ...
            >
              <svg className="w-5 h-5 text-[#0F172A] group-hover:text-[#0F172A] transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className="flex justify-center mt-4">
            <button
              ...
              className={`px-4 py-2 rounded-lg text-caption transition-all duration-200 focus-ring ${
                isAutoPlaying
                  ? 'bg-white/20 text-[#0F172A] border border-white/30'
                  : 'bg-white/10 hover:bg-white/20 text-[#0F172A]/80 border border-slate-300'
              }`}
            >
