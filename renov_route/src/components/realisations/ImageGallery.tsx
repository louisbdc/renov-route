...
export default function ImageGallery({ images, title }: ImageGalleryProps) {
        ...
        <div className="relative aspect-video rounded-lg overflow-hidden mx-2 my-4 group">
          ...
          >
            ...
            <div className="absolute inset-0 bg-black/0 group-hover:bg-black/20 transition-all duration-200 flex items-center justify-center">
              <svg className="w-8 h-8 text-[#0F172A] opacity-0 group-hover:opacity-100 transition-opacity duration-200" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  return (
    <div className="space-y-4">
      {/* Main image */}
      <div
        className="relative aspect-video rounded-lg overflow-hidden mx-2 my-4 group"
