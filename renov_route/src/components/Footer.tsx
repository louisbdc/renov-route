      ...
      <div className="max-w-6xl mx-auto">
        <div className="flex flex-col space-y-6">
          ...
          <div className="flex flex-wrap justify-center gap-x-6 gap-y-2 text-sm">
            ...
            <Link href="/competences" className="text-gray-400 hover:text-white transition-colors">Compétences</Link>
            <Link href="/realisations" className="text-gray-400 hover:text-white transition-colors">Réalisations</Link>
            <Link href="/guides" className="text-gray-400 hover:text-white transition-colors">Guides</Link>
            <Link href="/qui-sommes-nous" className="text-gray-400 hover:text-white transition-colors">Qui sommes-nous</Link>
            <Link href="/faq" className="text-gray-400 hover:text-white transition-colors">FAQ</Link>
            <Link href="/devis" className="text-gray-400 hover:text-white transition-colors">Devis</Link>
            <Link href="/mentions-legales" className="text-gray-400 hover:text-white transition-colors">Mentions légales</Link>
            <Link href="/privacy-policy" className="text-gray-400 hover:text-white transition-colors">Confidentialité</Link>
          </div>
