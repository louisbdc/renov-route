        ...
        <SafariAnimationFix>
          <section className="pt-32 pb-20 px-4 bg-[#141922]">
            <div className="max-w-6xl mx-auto">
              ...
              >
                <h1 className="text-3xl sm:text-4xl font-bold text-white mb-3">Qui sommes-nous ?</h1>
                    ...
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        ...
                        <ContactTracker type="phone" value="0786819692">
                          <a href="tel:0786819692" className="text-white text-base sm:text-lg hover:text-sky-400 transition-colors">
                            07 86 81 96 92
                          </a>
                        </ContactTracker>
                      </div>
                    ...
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        ...
                        <ContactTracker type="email" value="contact@renov-route.com">
                          <a href="mailto:contact@renov-route.com" className="text-white text-base sm:text-lg hover:text-sky-400 transition-colors">
              ...
              {/* À Propos */}
              <MotionDiv
                className="max-w-4xl mx-auto p-8 rounded-2xl border border-white/10 bg-white/[0.03]"
                initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: 1, y: 0 }}
                transition={{ duration: 0.5, delay: 0.3 }}
              >
                <h3 className="text-xl font-semibold text-white mb-6">À Propos de Rénov Route</h3>
