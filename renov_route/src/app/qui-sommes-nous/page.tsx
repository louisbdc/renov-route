        ...
        <SafariAnimationFix>
          ...
          <section className="pt-28 sm:pt-32 pb-12 px-4">
            <div className="max-w-6xl mx-auto">
              ...
              >
                <p className="text-amber-400 text-sm font-semibold mb-3 tracking-wide uppercase">
                  Qui sommes-nous
                </p>
                <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold text-white mb-4 font-display leading-tight">
              ...
              >
                {STATS.map((stat, i) => (
                  <div
                    key={i}
                    className="p-4 sm:p-5 rounded-xl border border-white/10 bg-[#0a0d11] text-center"
                  >
          ...
          <section className="py-10 px-4">
            <div className="max-w-6xl mx-auto">
              <div className="grid lg:grid-cols-2 gap-6">
                {/* Coordonnées */}
                <MotionDiv
                  className="p-6 sm:p-8 rounded-2xl border border-white/10 bg-[#0a0d11]"
                ...
                >
                  ...
                  <div className="space-y-5">
                    ...
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        <p className="text-gray-400 text-sm font-medium mb-0.5">Informations légales</p>
                ...
                >
                  ...
                  <div className="p-6 absolute bottom-0 left-0 right-0">
                    ...
                    <p className="text-white text-2xl font-bold mb-2">Xavier de Caumont</p>
            ...
            <div className="max-w-6xl mx-auto">
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-5">
                <div className="p-6 rounded-2xl border border-amber-500/30 bg-amber-500/5">
                  <h3 className="text-white font-semibold mb-3">Certification NF EN 1436</h3>
                ...
                <div className="p-6 rounded-2xl border border-white/10 bg-[#0a0d11]">
                  <h3 className="text-white font-semibold mb-3">Peinture acrylique routière</h3>
                  <p className="text-gray-400 text-sm leading-relaxed">
                ...
                <div className="p-6 rounded-2xl border border-white/10 bg-[#0a0d11]">
                  <h3 className="text-white font-semibold mb-3">Résine thermoplastique</h3>
                  <p className="text-gray-400 text-sm leading-relaxed">
                ...
                <div className="p-6 rounded-2xl border border-white/10 bg-[#0a0d11]">
                  <h3 className="text-white font-semibold mb-3">Résine époxy &amp; polyuréthane</h3>
                  <p className="text-gray-400 text-sm leading-relaxed">
                ...
                <div className="p-6 rounded-2xl border border-white/10 bg-[#0a0d11]">
                  <h3 className="text-white font-semibold mb-3">Enrobé à froid &amp; résine polyuréthane</h3>
                  <p className="text-gray-400 text-sm leading-relaxed">
                ...
                <div className="p-6 rounded-2xl border border-white/10 bg-[#0a0d11]">
                  <h3 className="text-white font-semibold mb-3">Conformité PMR &amp; normes ERP</h3>
                  <p className="text-gray-400 text-sm leading-relaxed">
            ...
            <div className="max-w-6xl mx-auto">
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
                {SERVICES.map((s, i) => (
                  ...
                  >
                    <h3 className="font-semibold text-white group-hover:text-amber-300 transition-colors mb-2">
                      {s.name}
                    </h3>
            ...
            <div className="max-w-6xl mx-auto">
              ...
              <div className="grid grid-cols-3 sm:grid-cols-4 md:grid-cols-6 gap-3 sm:gap-4">
                {PARTNERS.map((p, i) => (
                  <div
                    key={i}
                    className="aspect-square p-3 sm:p-4 rounded-xl border border-white/10 bg-white/95 flex items-center justify-center hover:border-amber-500/40 transition-colors"
                    title={p.name}
                  >
          ...
          <section className="py-14 px-4 border-t border-white/5">
            <div className="max-w-6xl mx-auto">
              ...
              >
                ...
                <Link
                  href="/realisations"
                  className="text-amber-400 hover:text-amber-300 font-medium text-sm sm:text-base transition-colors inline-flex items-center gap-2 whitespace-nowrap"
                >
              ...
              <div className="grid md:grid-cols-3 gap-5">
                {featuredRealisations.map((r, i) => (
                  <Link
                    ...
                    className="group rounded-xl overflow-hidden border border-white/10 bg-[#0a0d11] hover:border-white/20 transition-colors"
                  >
                    ...
                    <div className="p-5">
                      ...
                      <h3 className="font-semibold text-white group-hover:text-amber-300 transition-colors mb-2 leading-snug">
                        {r.client}
                      </h3>
              ...
              >
                ...
                <div className="space-y-4 text-gray-300 leading-relaxed">
                  ...
                  <p>
                    ...
                    Saint-Étienne, Grenoble, Valence, Annecy, Chambéry, Bourg-en-Bresse, Vienne — et
          ...
          <section className="py-14 px-4 border-t border-white/5">
            <div className="max-w-6xl mx-auto">
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4">
                <div className="p-5 rounded-xl border border-white/10 bg-[#0a0d11]">
                  <p className="text-2xl font-bold text-amber-400 mb-2">24 h</p>
                ...
                <div className="p-5 rounded-xl border border-white/10 bg-[#0a0d11]">
                  <p className="text-2xl font-bold text-amber-400 mb-2">48 h</p>
                  <h3 className="text-white font-semibold mb-2">Intervention rapide</h3>
                  <p className="text-gray-400 text-sm leading-relaxed">
                ...
                <div className="p-5 rounded-xl border border-white/10 bg-[#0a0d11]">
                  <p className="text-2xl font-bold text-amber-400 mb-2">5-10 ans</p>
                  <h3 className="text-white font-semibold mb-2">Durabilité garantie</h3>
                  <p className="text-gray-400 text-sm leading-relaxed">
                ...
                <div className="p-5 rounded-xl border border-white/10 bg-[#0a0d11]">
                  <p className="text-2xl font-bold text-amber-400 mb-2">100 %</p>
