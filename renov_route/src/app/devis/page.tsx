        ...
        <SafariAnimationFix>
          <section className="pt-24 sm:pt-32 pb-20 px-4 bg-[#141922]">
            <div className="max-w-6xl mx-auto">
              {isSubmitted ? (
                <div className="max-w-2xl mx-auto text-center py-16 border border-white/10 bg-[#1a1f2a] rounded-2xl px-8">
                ...
                <div className="grid lg:grid-cols-5 gap-8 relative">
                  ...
                  <div className="lg:col-span-3">
                    ...
                    <MotionDiv
                      className="border border-white/10 bg-[#1a1f2a] rounded-2xl p-6 sm:p-8"
                      initial={{ opacity: 0, y: 20 }}
                      animate={{ opacity: 1, y: 0 }}
                  ...
                  <div className="lg:col-span-2 space-y-5">
                    ...
                    >
                      ...
                      {advantages.map((advantage, index) => (
                        <div
                          key={index}
                          className="p-5 rounded-xl border border-white/10 bg-[#1a1f2a]"
                        >
