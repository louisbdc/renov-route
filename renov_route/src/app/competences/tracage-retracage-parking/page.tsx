  ...
  return (
    <>
      ...
      <ServicePageLayout
        ...
        heroSubtitle="Un marquage de parking professionnel améliore la circulation, optimise l'espace et renforcé la sécurité. Traçage conforme aux normes en vigueur."
        ...
        descriptionParagraphs={[
          'Le marquage au sol de parking est un élément déterminant pour l\'image de votre établissement. Un parking bien marqué améliore la circulation, optimise l\'utilisation de l\'espace et renforcé la sécurité des usagers.',
