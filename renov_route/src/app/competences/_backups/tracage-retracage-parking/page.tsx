  ...
  return (
    <>
      ...
      <BreadcrumbSchema items={[
        ...
        { name: "Traçage et retraçage de parking", url: "https://www.renov-route.com/competences/tracage-retracage-parking" }
      ]} />
        <script type="application/ld+json">
          {JSON.stringify({
            "@context": "https://schema.org",
            "@type": "Service",
            "name": "Marquage au Sol Lyon - Traçage et Retraçage de Parking",
            "description": "Entreprise marquage au sol Lyon : traçage et retraçage de parking professionnel. Marquage au sol durable, peinture sol parking Lyon, respect des normes, finition soignée.",
            "provider": {
              "@type": "LocalBusiness",
              "name": "Renov Route"
            },
