...
function GuideCard({ guide }: { guide: Guide }) {
  return (
    <Link
      ...
      className="group flex flex-col h-full p-6 rounded-2xl border border-white/15 bg-white/[0.06] backdrop-blur-sm hover:border-sky-400/30 hover:bg-white/[0.1] transition-all duration-300 hover:-translate-y-1 hover:shadow-lg hover:shadow-sky-500/5"
    >
      <span className="inline-block self-start text-xs px-3 py-1 rounded-full bg-sky-500/15 text-sky-400 font-medium border border-sky-500/25 mb-4">
        {GUIDE_CATEGORIES[guide.category]}
      </span>
      <h2 className="text-lg font-semibold text-white mb-3 group-hover:text-sky-300 transition-colors leading-snug">
        {guide.title}
      </h2>
      ...
      <SafariAnimationFix>
        ...
        <section className="py-12 sm:py-16 px-4 relative overflow-hidden border-t border-white/5">
          ...
          <div className="relative max-w-2xl mx-auto text-center">
            ...
            <Link
              href="/devis"
              className="inline-block bg-sky-500 hover:bg-sky-400 text-white font-semibold py-3 px-7 rounded-lg transition-colors duration-200"
            >
