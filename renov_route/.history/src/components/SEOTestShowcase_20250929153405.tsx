...
export default function SEOTestShowcase() {
  ...
  const projectData = {
    ...
    budget: "15 000€",
    status: "completed",
    services: ["Traçage de parking", "Signalisation verticale", "Accessoires parking"],
    cta: {
      text: "Voir le projet",
      link: "/realisations",
      type: "primary" as const
  ...
  const testimonialData = {
    ...
    text: "Excellent service de marquage de parking. Travail professionnel et respect des délais.",
    rating: 5,
    image: "/assets/images/realisations/parking-1.avif",
