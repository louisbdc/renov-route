...
export default function Lightbox({ 
  ...
  const lightboxContent = (
    <div className="relative w-full h-full flex items-center justify-center p-4" onClick={(e) => e.stopPropagation()}>
      ...
      {/* Image container */}
      <div className="relative max-w-[90vw] max-h-[65vh] flex items-center justify-center">
        {isSafari ? (
      ...
      {/* Image counter */}
      {images.length > 1 && (
        <div className="absolute bottom-20 left-1/2 transform -translate-x-1/2 px-4 py-2 bg-black/50 border border-white/20 rounded-full text-white text-sm">
      ...
      {/* Thumbnails */}
      {images.length > 1 && (
        <div className="absolute bottom-8 left-1/2 transform -translate-x-1/2 flex gap-2 max-w-full overflow-x-auto px-4 py-2">
