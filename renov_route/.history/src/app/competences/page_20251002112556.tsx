...
const competences = [
  {
    id: 1,
    title: 'Marquage au sol France - Traçage et retraçage de parking',
    description: 'Entreprise marquage au sol basée à Lyon, nous intervenons dans toute la France : un parking bien entretenu attire les clients et améliore l\'expérience utilisateur.',
    icon: '🅿️',
    features: [
      'Marquage au sol professionnel France',
      'Marquage lignes de parking Lyon',
      'Peinture sol parking partout en France',
  ...
  {
    id: 2,
    title: 'Signalisation routière France - Signalisation verticale',
    description: 'Signalisation routière dans toute la France : tous les panneaux verticaux de parking (exemple : stop, panneau PMR, cédez le passage, etc.)',
    icon: '🚦',
    features: [
      'Signalisation horizontale France',
      'Panneaux de signalisation',
      'Marquage passage piéton Lyon',
      'Installation professionnelle France',
  ...
  {
    id: 3,
    title: 'Revêtement epoxy sol France - Résine de sol et marquage d\'intérieur',
    description: 'Entreprise sol epoxy basée à Lyon, nous intervenons dans toute la France : solutions complètes de résine pour sols et marquage intérieur professionnel.',
    icon: '🏗️',
    features: [
      'Revêtement epoxy sol Lyon',
      'Résine décorative sol France',
      'Peinture sol garage partout en France',
      'Peinture sol industriel France',
      'Marquage intérieur professionnel',
  ...
  {
    id: 5,
    title: 'Marquage au sol entrepôt France - Accessoires de parking',
    description: 'Marquage au sol entrepôt dans toute la France : équipements de sécurité et d\'organisation pour optimiser la circulation et protéger les infrastructures de votre parking.',
    icon: '🛡️',
    features: [
      'Peinture sol entrepôt Lyon',
      'Traçage places handicapés France',
      'Bornes anti-bélier',
      'Ralentisseurs',
      'Butées de parking',
      'Déplacement dans toute la France'
  ...
  return (
    <>
      ...
      <section className="hidden" aria-hidden="true">
        <h2>FAQ Marquage au Sol France - Entreprise Marquage au Sol Lyon</h2>
        <h3>Intervenez-vous dans toute la France ?</h3>
        <p>Oui, nous sommes une entreprise marquage au sol basée à Lyon qui intervient dans toute la France. Nous proposons le marquage parking France, peinture sol parking Lyon, marquage lignes de parking partout en France, traçage places handicapés France, marquage passage piéton Lyon et signalisation horizontale France.</p>

        <h3>Proposez-vous des services de peinture epoxy dans toute la France ?</h3>
        <p>Oui, nous sommes une entreprise sol epoxy basée à Lyon qui intervient dans toute la France. Nous proposons la peinture sol garage Lyon, peinture sol industriel France, revêtement epoxy sol Lyon, résine décorative sol France et peinture sol antidérapante partout en France.</p>

        <h3>Quels services pour les entrepôts et garages en France ?</h3>
        <p>Nous proposons le marquage au sol entrepôt France, peinture sol entrepôt Lyon, sol epoxy garage particulier France, réparation sol béton Lyon et rénovation sol parking France. Nous nous déplaçons dans toute la France.</p>

        <h3>Vos services de signalisation routière en France ?</h3>
        <p>Oui, nous offrons la signalisation routière France, signalisation horizontale Lyon, entreprise peinture sol extérieur France et entreprise marquage voirie Lyon pour tous vos besoins de signalisation partout en France.</p>

        <h3>Proposez-vous des devis marquage sol dans toute la France ?</h3>
        <p>Oui, nous établissons des devis marquage sol France personnalisés avec prix peinture sol epoxy Lyon transparents. Contactez-nous pour un devis gratuit et adapté à vos besoins partout en France.</p>

        <h3>Intervenez-vous sur les terrains de sport en France ?</h3>
        <p>Oui, nous proposons le traçage terrain de sport France avec des matériaux résistants et conformes aux normes sportives pour tous types de terrains et équipements sportifs. Nous nous déplaçons dans toute la France.</p>

        <h3>Vos services respectent-ils les normes françaises ?</h3>
        <p>Oui, tous nos services de marquage au sol France respectent scrupuleusement les normes françaises de signalisation horizontale (NF EN 1436) et les réglementations en vigueur pour garantir la conformité et la sécurité partout en France.</p>

        <h3>Quels types d'accessoires de parking installez-vous ?</h3>
        <p>Nous installons une gamme complète d'accessoires dans toute la France : bornes anti-bélier, ralentisseurs, butées de parking, barrières, éclairage de sécurité et signalétique pour optimiser la sécurité et l'organisation de vos parkings partout en France.</p>
      </section>
    </>
  );
}
