...
export const metadata: Metadata = {
  ...
  description: 'Conseil et expertise pour vos projets d\'amélioration. Étude de faisabilité, devis personnalisé, suivi de projet. Notre équipe vous accompagne dans vos projets d\'infrastructure.',
  alternates: {
