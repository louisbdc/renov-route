...
export const metadata: Metadata = {
  ...
  description: 'Solutions complètes de résine pour sols et marquage intérieur professionnel. Revêtements durables, marquage industriel, finition esthétique pour tous espaces intérieurs.',
  alternates: {
