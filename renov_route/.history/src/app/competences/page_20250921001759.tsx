...
export const metadata: Metadata = {
  ...
  description: 'Découvrez nos compétences en traçage marquage routier : réparation nids de poule, retraçage parking, marquage au sol, signalisation verticale, résine de sol. Expert en France avec 10+ ans d\'expérience.',
  alternates: {
