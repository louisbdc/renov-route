...
export const metadata: Metadata = {
  title: "Signalisation Verticale - Panneaux Parking Professionnel",
  description: "Installation de panneaux de signalisation verticale pour parking : stop, PMR, cédez le passage. Installation professionnelle avec conformité aux normes françaises. Devis gratuit.",
  keywords: "signalisation verticale, panneaux parking, panneau PMR, panneau stop, panneau cédez le passage, installation panneaux, signalisation routière, normes signalisation",
  openGraph: {
    title: "Signalisation Verticale - Panneaux Parking Professionnel",
    description: "Installation de panneaux de signalisation verticale pour parking : stop, PMR, cédez le passage. Installation professionnelle avec conformité aux normes.",
  ...
  twitter: {
    ...
    title: "Signalisation Verticale - Panneaux Parking Professionnel",
    description: "Installation de panneaux de signalisation verticale pour parking. Devis gratuit.",
    images: ["https://renov-route.com/assets/images/signalisation-verticale-twitter.jpg"]
  },
  alternates: {
...
export default function SignalisationVerticalePage() {
  ...
  useEffect(() => {
    ...
    canonicalLink.href = 'https://renov-route.com/competences/signalisation-verticale';
  ...
  return (
    <>
      ...
      <Head>
        <title>Signalisation Verticale - Panneaux de Parking Professionnels | Renov Route</title>
        <meta name="description" content="Signalisation verticale professionnelle : tous les panneaux verticaux de parking (stop, PMR, cédez le passage). Installation conforme aux normes." />
        <meta name="keywords" content="signalisation verticale, panneaux parking, panneau stop, panneau PMR, cédez le passage, signalisation professionnelle, installation panneaux" />
        <meta name="robots" content="index, follow, max-snippet:-1, max-image-preview:large, max-video-preview:-1" />
        <meta property="og:title" content="Signalisation Verticale - Panneaux de Parking Professionnels | Renov Route" />
        <meta property="og:description" content="Signalisation verticale professionnelle : tous les panneaux verticaux de parking (stop, PMR, cédez le passage)." />
        <meta property="og:url" content="https://renov-route.com/competences/signalisation-verticale" />
        <meta property="og:type" content="website" />
        <meta name="twitter:title" content="Signalisation Verticale - Panneaux de Parking Professionnels | Renov Route" />
        <meta name="twitter:description" content="Signalisation verticale professionnelle : tous les panneaux verticaux de parking." />
        <link rel="canonical" href="https://renov-route.com/competences/signalisation-verticale" />
