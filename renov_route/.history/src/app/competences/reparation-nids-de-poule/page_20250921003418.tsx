...
export const metadata: Metadata = {
  title: "Réparation Nids de Poule - Expert Résine Durable & Rapide",
  description: "Réparation professionnelle de nids de poule avec de la résine haute performance. Procédé innovant, durable et résistant aux intempéries. Intervention rapide sur routes, parkings et voies privées. Devis gratuit, matériaux de qualité.",
  keywords: "réparation nids de poule, résine réparation route, enrobé résine, réparation chaussée, réparation parking, résine haute performance, réparation durable route, procédé réparation route, intervention rapide route, devis réparation nids poule",
  openGraph: {
    title: "Réparation Nids de Poule - Expert Résine Durable & Rapide",
    description: "Réparation professionnelle de nids de poule avec de la résine haute performance. Procédé innovant, durable et résistant aux intempéries.",
  ...
  twitter: {
    ...
    title: "Réparation Nids de Poule - Expert Résine Durable & Rapide",
    description: "Réparation professionnelle de nids de poule avec de la résine haute performance. Devis gratuit.",
    images: ["https://renov-route.com/assets/images/reparation-nids-poule-twitter.jpg"]
  },
  alternates: {
...
export default function ReparationNidsDePoulePage() {
  ...
  useEffect(() => {
    ...
    canonicalLink.href = 'https://renov-route.com/competences/reparation-nids-de-poule';
  ...
  return (
    <>
      <Head>
        <title>Réparation de Nids de Poule - Expert Résine | Renov Route</title>
        <meta name="description" content="Réparation professionnelle de nids de poule avec de la résine. Procédé innovant, durable et résistant. Intervention rapide sur tous types de routes. Devis gratuit." />
        <meta name="keywords" content="réparation nids de poule, résine réparation route, réparation chaussée, nids de poule professionnel, réparation route durable, résine à froid, réparation infrastructure routière" />
        <meta name="robots" content="index, follow, max-snippet:-1, max-image-preview:large, max-video-preview:-1" />
        <meta property="og:title" content="Réparation de Nids de Poule - Expert Résine | Renov Route" />
        <meta property="og:description" content="Réparation professionnelle de nids de poule avec de la résine. Procédé innovant, durable et résistant. Intervention rapide sur tous types de routes." />
        <meta property="og:url" content="https://renov-route.com/competences/reparation-nids-de-poule" />
        <meta property="og:type" content="website" />
        <meta name="twitter:title" content="Réparation de Nids de Poule - Expert Résine | Renov Route" />
        <meta name="twitter:description" content="Réparation professionnelle de nids de poule avec de la résine. Procédé innovant, durable et résistant." />
        <link rel="canonical" href="https://renov-route.com/competences/reparation-nids-de-poule" />
