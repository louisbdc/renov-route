...
export const metadata: Metadata = {
  ...
  description: 'Réparation professionnelle de nids de poule avec de la résine. Procédé innovant, durable et résistant. Intervention rapide sur tous types de routes. Devis gratuit.',
  alternates: {
