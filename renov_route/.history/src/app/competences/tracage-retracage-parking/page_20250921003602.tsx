...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "Traçage Retraçage Parking - Marquage Professionnel Durable",
    description: "Traçage et retraçage de parking professionnel avec marquage au sol durable. Respect des normes en vigueur, finition soignée.",
  ...
  twitter: {
    ...
    title: "Traçage Retraçage Parking - Marquage Professionnel Durable",
    description: "Traçage et retraçage de parking professionnel avec marquage au sol durable. Devis gratuit.",
    images: ["https://renov-route.com/assets/images/tracage-parking-twitter.jpg"]
  },
  alternates: {
