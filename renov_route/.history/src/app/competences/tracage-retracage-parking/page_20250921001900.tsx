...
export const metadata: Metadata = {
  ...
  description: 'Traçage et retraçage de parking professionnel. Marquage au sol durable, respect des normes, finition soignée. Améliorez l\'expérience client de votre parking.',
  alternates: {
