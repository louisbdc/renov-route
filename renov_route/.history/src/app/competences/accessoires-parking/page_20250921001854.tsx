...
export const metadata: Metadata = {
  ...
  description: 'Accessoires de parking professionnels : bornes anti-bélier, ralentisseurs, butées de parking. Installation et maintenance d\'équipements de sécurité pour parkings.',
  alternates: {
