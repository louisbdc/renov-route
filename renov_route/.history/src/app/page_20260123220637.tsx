                        ...
                        <div className="relative z-10 w-full h-full">
                            <div className="flex items-center min-h-screen">
                                ...
                                <div className="text-white px-2 sm:px-4 lg:px-6 flex items-center justify-center min-h-screen w-full md:w-1/2 pt-16 md:pt-0">
                                    ...
                                    {isSafari ? (
                                        <div className="glassmorphism-card p-3 sm:p-4 md:p-6 rounded-[1.5rem] border border-white/20 text-left w-full max-w-md">
                                        ...
                                        <motion.div
                                            className="glassmorphism-card p-3 sm:p-4 md:p-6 rounded-[1.5rem] border border-white/20 text-left w-full max-w-md"
