...
export const metadata: Metadata = {
  title: 'Qui Sommes-Nous - Équipe Expert Traçage Marquage Routier | Renov Route',
  description: 'Découvrez l\'équipe Renov Route, experts en traçage marquage routier depuis 2014. Spécialistes réparation nids de poule, marquage parking, signalisation. Intervention dans toute la France.',
  keywords: 'équipe marquage routier, qui sommes-nous, experts traçage parking, spécialistes réparation nids de poule, équipe Renov Route, professionnels marquage au sol, experts signalisation',
  robots: 'index, follow, max-snippet:-1, max-image-preview:large, max-video-preview:-1',
  openGraph: {
    title: 'Qui Sommes-Nous - Équipe Expert Traçage Marquage Routier | Renov Route',
    description: 'Découvrez l\'équipe Renov Route, experts en traçage marquage routier depuis 2014. Spécialistes réparation nids de poule, marquage parking.',
  ...
  twitter: {
    ...
    title: 'Qui Sommes-Nous - Équipe Expert Traçage Marquage Routier | Renov Route',
    description: 'Découvrez l\'équipe Renov Route, experts en traçage marquage routier depuis 2014. Spécialistes réparation nids de poule.',
  },
  alternates: {
  ...
  return (
    <>
      ...
      <SEOHead 
        ...
        canonicalUrl="https://renov-route.com/qui-sommes-nous"
      />
