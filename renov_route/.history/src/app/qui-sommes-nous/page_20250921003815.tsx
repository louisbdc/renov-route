...
export const metadata: Metadata = {
  title: "Qui Sommes Nous - Équipe Expert Traçage Marquage Routier",
  description: "Découvrez l'équipe Renov Route, experts en traçage marquage routier depuis 10+ ans. 1000+ projets réalisés, 98% de clients satisfaits. Intervention dans toute la France.",
  ...
  openGraph: {
    title: "Qui Sommes Nous - Équipe Expert Traçage Marquage Routier",
    description: "Découvrez l'équipe Renov Route, experts en traçage marquage routier depuis 10+ ans. 1000+ projets réalisés, 98% de clients satisfaits.",
  ...
  twitter: {
    ...
    title: "Qui Sommes Nous - Équipe Expert Traçage Marquage Routier",
    description: "Découvrez l'équipe Renov Route, experts en traçage marquage routier depuis 10+ ans.",
    images: ["https://renov-route.com/assets/images/qui-sommes-nous-twitter.jpg"]
  },
  alternates: {
...
export default function ContactPage() {
  ...
  useEffect(() => {
    ...
    canonicalLink.href = 'https://renov-route.com/qui-sommes-nous';
  ...
  return (
    <>
      ...
      <Head>
        <title>Qui sommes-nous - Expert Traçage Marquage Routier | Renov Route</title>
        <meta name="description" content="Découvrez Rénov Route, expert en traçage marquage routier et réparation de nids de poule. Notre histoire, notre équipe et notre mission pour la sécurité routière. Contact : 07 86 81 96 92." />
        <meta name="keywords" content="qui sommes nous rénov route, équipe marquage routier, fondateur xavier de caumont, histoire entreprise, mission sécurité routière, expert traçage, spécialiste marquage" />
        <meta name="robots" content="index, follow, max-snippet:-1, max-image-preview:large, max-video-preview:-1" />
        <meta property="og:title" content="Qui sommes-nous - Expert Réparation Nids de Poule et Marquage Routier | Rénov Route" />
        <meta property="og:description" content="Découvrez Rénov Route, expert en traçage marquage routier et réparation de nids de poule. Notre histoire, notre équipe et notre mission pour la sécurité routière." />
        <meta property="og:url" content="https://renov-route.com/qui-sommes-nous" />
        <meta property="og:type" content="website" />
        <meta name="twitter:title" content="Qui sommes-nous - Expert Réparation Nids de Poule et Marquage Routier | Rénov Route" />
        <meta name="twitter:description" content="Découvrez Rénov Route, expert en traçage marquage routier et réparation de nids de poule. Notre histoire, notre équipe et notre mission pour la sécurité routière." />
        <link rel="canonical" href="https://renov-route.com/qui-sommes-nous" />
