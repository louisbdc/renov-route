...
export const metadata: Metadata = {
  ...
  description: 'Découvrez nos réalisations en traçage marquage routier : réparation nids de poule, retraçage parking, marquage au sol. Projets réalisés en France avec expertise et qualité.',
  alternates: {
