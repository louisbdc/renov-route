...
export const metadata: Metadata = {
  ...
  description: 'Découvrez nos réalisations en traçage marquage routier : parkings Lidl, Intermarché, Carrefour, réparation nids de poule, signalisation PMR. Projets réussis dans toute la France.',
  keywords: 'réalisations marquage routier, projets traçage parking, références marquage au sol, travaux réalisés, parkings Lidl, Intermarché, Carrefour, réparation nids de poule, signalisation PMR, projets réussis',
  robots: 'index, follow, max-snippet:-1, max-image-preview:large, max-video-preview:-1',
  openGraph: {
    title: 'Nos Réalisations - Projets Traçage Marquage Routier | Renov Route',
    description: 'Découvrez nos réalisations en traçage marquage routier : parkings Lidl, Intermarché, Carrefour, réparation nids de poule, signalisation PMR.',
  ...
  twitter: {
    ...
    title: 'Nos Réalisations - Projets Traçage Marquage Routier | Renov Route',
    description: 'Découvrez nos réalisations en traçage marquage routier : parkings Lidl, Intermarché, Carrefour, réparation nids de poule.',
  },
  alternates: {
...
function RealisationsContent() {
  ...
  useEffect(() => {
    ...
    canonicalLink.href = 'https://renov-route.com/realisations';
  ...
  return (
    <>
      <SEOHead 
        title="Réalisations - Portfolio Projets Marquage Routier & Parking"
        description="Découvrez nos réalisations en traçage marquage routier, réparation nids de poule, retraçage parking. Portfolio de projets pour Carrefour, Lidl, Intermarché et autres entreprises. 1000+ projets réalisés."
