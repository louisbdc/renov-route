...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "Réalisations - Portfolio Projets Marquage Routier & Parking",
    description: "Découvrez nos réalisations en traçage marquage routier, réparation nids de poule, retraçage parking. Portfolio de projets pour grandes entreprises.",
  ...
  twitter: {
    ...
    title: "Réalisations - Portfolio Projets Marquage Routier & Parking",
    description: "Découvrez nos réalisations en traçage marquage routier, réparation nids de poule, retraçage parking.",
    images: ["https://renov-route.com/assets/images/realisations-twitter.jpg"]
  },
  alternates: {
