      ...
      <Layout>
        ...
        <section id="projects-grid" className="py-16">
          <div className="container-custom">
            ...
            {/* Grille statique des premiers projets pour le SEO avec glassmorphism */}
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              {caseStudies.slice(0, 6).map((caseStudy) => (
                <div key={caseStudy.id} className="glassmorphism-card rounded-xl overflow-hidden hover:shadow-2xl transition-all duration-300 group border border-white/20 hover:border-white/30">
                  <div className="relative h-48">
                    ...
                    <div className="absolute top-4 left-4">
                      <span className="bg-gradient-to-r from-blue-500 to-cyan-500 text-white text-sm font-semibold px-3 py-1 rounded-full">
                        {caseStudy.category}
                      </span>
                    </div>
                  ...
                  <div className="p-6 bg-white/10 backdrop-blur-md">
                    ...
                    <p className="text-gray-200 mb-4 line-clamp-2 group-hover:text-gray-100 transition-colors">
                      {caseStudy.summary}
                    </p>
                    <div className="flex items-center justify-between text-sm text-gray-300 group-hover:text-gray-200 transition-colors">
