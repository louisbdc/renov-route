                    ...
                    >
                        ...
                        <div className="relative z-10 w-full h-full">
                            <div className="flex items-center min-h-screen">
                                {/* Content - Partie gauche avec glassmorphism dans le quart gauche */}
                                <div className="text-white px-2 sm:px-4 lg:px-6 flex items-start lg:items-center justify-start lg:justify-center min-h-screen w-full lg:w-1/4 pt-16 lg:pt-0">
