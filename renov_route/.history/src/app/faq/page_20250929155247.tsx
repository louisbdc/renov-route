          ...
          <section className="pt-24 sm:pt-28 lg:pt-32 pb-12 sm:pb-16 px-4 relative overflow-hidden">
            ...
            <div className="relative max-w-6xl mx-auto text-center">
              ...
              >
                <Link 
                  href="/devis" 
                  className="bg-blue-600/80 backdrop-blur-md border border-blue-500/50 text-white hover:bg-blue-600 hover:border-blue-400 px-8 py-3 rounded-xl font-semibold transition-all duration-300 shadow-lg"
                >
                  Devis Gratuit
                </Link>
                <Link 
