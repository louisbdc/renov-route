...
export const metadata: Metadata = {
  title: "Devis Gratuit - Traçage Marquage Routier & Réparation Nids de Poule",
  description: "Demandez votre devis gratuit pour traçage marquage routier, réparation nids de poule, retraçage parking, signalisation verticale. Estimation rapide sous 24h. Intervention dans toute la France.",
  ...
  openGraph: {
    title: "Devis Gratuit - Traçage Marquage Routier & Réparation Nids de Poule",
    description: "Demandez votre devis gratuit pour traçage marquage routier, réparation nids de poule, retraçage parking. Estimation rapide sous 24h.",
  ...
  twitter: {
    ...
    title: "Devis Gratuit - Traçage Marquage Routier & Réparation Nids de Poule",
    description: "Demandez votre devis gratuit pour traçage marquage routier. Estimation rapide sous 24h.",
    images: ["https://renov-route.com/assets/images/devis-twitter.jpg"]
  },
  alternates: {
...
export default function DevisPage() {
  ...
  useEffect(() => {
    ...
    canonicalLink.href = 'https://renov-route.com/devis';
  ...
  return (
    <>
      <Head>
        <title>Devis Gratuit - Traçage Marquage Routier | Renov Route</title>
        <meta name="description" content="Demandez votre devis gratuit pour traçage marquage routier, réparation nids de poule, marquage parking. Estimation personnalisée sous 24h. Formulaire simple et rapide." />
        <meta name="keywords" content="devis traçage gratuit, devis marquage routier, estimation parking, devis réparation route, demande devis marquage, calcul prix traçage, devis en ligne marquage" />
        <meta name="robots" content="index, follow, max-snippet:-1, max-image-preview:large, max-video-preview:-1" />
        <meta property="og:title" content="Devis Gratuit - Traçage Marquage Routier | Renov Route" />
        <meta property="og:description" content="Demandez votre devis gratuit pour traçage marquage routier, réparation nids de poule, marquage parking. Estimation personnalisée sous 24h." />
        <meta property="og:url" content="https://renov-route.com/devis" />
        <meta property="og:type" content="website" />
        <meta name="twitter:title" content="Devis Gratuit - Traçage Marquage Routier | Renov Route" />
        <meta name="twitter:description" content="Demandez votre devis gratuit pour traçage marquage routier, réparation nids de poule, marquage parking." />
        <link rel="canonical" href="https://renov-route.com/devis" />
