...
export const metadata: Metadata = {
  title: 'Devis Gratuit - Traçage Marquage Routier & Réparation Nids de Poule | Renov Route',
  ...
  twitter: {
    ...
    title: 'Devis Gratuit - Traçage Marquage Routier | Renov Route',
    description: 'Demandez votre devis gratuit pour traçage marquage routier, réparation nids de poule, marquage parking.',
  },
  alternates: {
