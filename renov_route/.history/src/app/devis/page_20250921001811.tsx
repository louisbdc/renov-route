...
export const metadata: Metadata = {
  ...
  description: 'Demandez votre devis gratuit pour vos travaux de traçage marquage routier, réparation nids de poule, retraçage parking. Expert en France, intervention rapide, prix compétitifs.',
  alternates: {
