...
export const metadata: Metadata = {
  title: 'Renov Route - Expert Traçage Marquage Routier & Parking France | Devis Gratuit',
  description: 'Renov Route : Expert traçage marquage routier et parking en France. Réparation nids de poule, retraçage parking, marquage routier, enrobé résine. Devis gratuit, intervention rapide. 10+ ans d\'expérience, 1000+ projets réalisés.',
  alternates: {
