...
[https://docs.squirrelscan.com/rules/{rule\_category}/{rule\_id}](https://docs.squirrelscan.com/rules/%7Brule_category%7D/%7Brule_id%7D)

example:

[https://docs.squirrelscan.com/rules/links/external-links](https://docs.squirrelscan.com/rules/links/external-links)
...
Maximum pages to crawl (max 500)
...
See [OUTPUT-FORMAT.md](https://github.com/squirrelscan/skills/blob/main/audit-website/references/OUTPUT-FORMAT.md) for detailed format specification.
...
*   **Output Format Reference**: [OUTPUT-FORMAT.md](https://github.com/squirrelscan/skills/blob/main/audit-website/references/OUTPUT-FORMAT.md)
*   **squirrelscan Documentation**: [https://docs.squirrelscan.com](https://docs.squirrelscan.com)
