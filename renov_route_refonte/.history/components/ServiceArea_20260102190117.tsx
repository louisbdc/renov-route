...
export default function ServiceArea() {
  ...
  useEffect(() => {
    const updateScrollProgress = () => {
      ...
      // Commencer l'animation quand la section entre dans le viewport (80% du viewport)
      const triggerPoint = windowHeight * 0.8
      const animationStart = sectionTop - triggerPoint
      const animationEnd = animationStart + sectionHeight * 0.4 // Animation sur 40% de la hauteur de la section (plus court)
