  ...
  return (
    <section id="contact" className="py-24 relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto px-6 relative z-10">
        <div className="glass-panel rounded-[32px] p-8 md:p-12 border border-safety/20 shadow-neon text-center">
          <span className="material-symbols-outlined text-6xl text-safety mb-6">history_edu</span>
          ...
          <form onSubmit={handleSubmit} className="max-w-md mx-auto space-y-4 text-left">
            <div>
              ...
              <input 
                ...
                className="w-full bg-black/30 border border-gray-700 rounded-lg px-4 py-3 text-white focus:border-safety focus:ring-1 focus:ring-safety outline-none transition-all"
              />
            </div>
            <div>
              <label className="block text-xs font-bold text-gray-500 uppercase tracking-wider mb-2">
          ...
          <div className="mt-12 pt-8 border-t border-gray-700 flex flex-col md:flex-row justify-between items-center text-sm text-gray-500">
            <p>© 2024 Rénov Route. Tous droits réservés.</p>
