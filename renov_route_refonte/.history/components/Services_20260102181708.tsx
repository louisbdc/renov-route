...
export default function Services() {
  ...
  useEffect(() => {
    if (displacementRef.current) {
      displacementRef.current.setAttribute('scale', isHovered ? '80' : '0')
    }
  }, [isHovered])
  ...
  const handleMouseMove = (e: React.MouseEvent<HTMLElement>) => {
    ...
    // Augmentation de l'amplitude pour un effet plus visible
    const intensityX = (x / rect.width) * 0.03
    const intensityY = (y / rect.height) * 0.03
