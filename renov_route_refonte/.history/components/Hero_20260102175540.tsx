    ...
    <header className="relative min-h-screen flex items-center justify-center pt-20 overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 text-center">
        ...
        <h1 className="flex flex-col items-center mb-6">
          ...
          <span className="font-sans text-lg md:text-2xl text-gray-200 font-medium tracking-wide max-w-2xl mx-auto">
            Spécialiste Marquage Routier & Signalisation à Lyon et en Rhône-Alpes
          </span>
        </h1>
