...
export default function Services() {
  ...
  return (
    ...
    >
      ...
      {/* Arrière-plan avec distorsion - Utilisation d'un SVG pour que le filtre fonctionne */}
      <svg 
      ...
      {/* Orbes de couleur pour rendre la distorsion évidente */}
      <div 
      ...
      <div className="absolute top-1/4 left-1/4 w-96 h-96 bg-blue-500/30 rounded-full blur-3xl mix-blend-screen animate-pulse pointer-events-none" />
      <div className="absolute bottom-1/4 right-1/4 w-96 h-96 bg-cyan-500/25 rounded-full blur-3xl mix-blend-screen pointer-events-none" />
