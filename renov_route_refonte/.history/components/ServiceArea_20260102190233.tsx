...
export default function ServiceArea() {
  ...
  useEffect(() => {
    const updateScrollProgress = () => {
      ...
      // Commencer l'animation plus tôt, avant que le conteneur entre dans le viewport (120% du viewport)
      // Finir l'animation plus tôt, quand le conteneur arrive à 70% du viewport
      ...
      if (containerTop < startPoint) {
        // Le conteneur est dans ou approche la zone d'animation
