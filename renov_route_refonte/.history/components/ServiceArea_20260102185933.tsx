...
export default function ServiceArea() {
  ...
  const [containerHeight, setContainerHeight] = useState(222) // Valeur par défaut
  
  useEffect(() => {
    const updateHeight = () => {
      if (areasContainerRef.current) {
        // Hauteur totale moins les espacements (space-y-6 = 24px entre chaque élément, donc 2 espacements pour 3 éléments = 48px)
        const height = areasContainerRef.current.scrollHeight - 48
      ...
      <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-16 items-center">
        ...
        <div className="order-1 lg:order-2">
          ...
          <div ref={areasContainerRef} className="space-y-6 relative pl-4">
            ...
            <div className="absolute left-0 top-0 w-1 h-full min-h-[222px] rounded-full bg-gray-700"></div>
