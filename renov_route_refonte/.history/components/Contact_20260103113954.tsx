      ...
      <div className="max-w-4xl mx-auto px-6 relative z-10">
        <div className="glass-panel rounded-[32px] p-8 md:p-12 border border-brand/20 shadow-neon text-center">
          ...
          <p className="text-gray-300 text-lg mb-4 max-w-2xl mx-auto">
            Commencez une conversation avec nous pour vos travaux de marquage au sol ou de réparation. 
            Réponse garantie sous 24h ouvrées.
          </p>
          <p className="text-brand-neon text-sm mb-10 max-w-2xl mx-auto font-semibold">
            ⚠️ Un devis est toujours nécessaire avant toute intervention.
          </p>
          ...
          <form onSubmit={handleSubmit} className="max-w-md mx-auto space-y-4 text-left">
            ...
            <div>
              ...
              <select className="w-full bg-black/30 border border-gray-700 rounded-lg px-4 py-3 text-white focus:border-brand outline-none appearance-none">
            ...
            <button 
              type="submit" 
              className="w-full py-4 bg-brand text-white font-display font-bold text-xl rounded-lg hover:bg-brand-light hover:shadow-neon transition-all duration-300 mt-4"
            >
              ENVOYER MA DEMANDE
            </button>
          </form>
          ...
          <div className="mt-12 pt-8 border-t border-gray-700 flex flex-col md:flex-row justify-between items-center text-sm text-gray-500">
            ...
            <div className="flex space-x-4 mt-4 md:mt-0">
              <Link href="/mentions-legales" className="hover:text-brand-neon transition-colors">Mentions Légales</Link>
              <Link href="/privacy-policy" className="hover:text-brand-neon transition-colors">Confidentialité</Link>
            </div>
          </div>
        </div>
      </div>
