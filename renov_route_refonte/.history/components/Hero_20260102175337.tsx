    ...
    <header className="relative min-h-screen flex items-center justify-center pt-20 overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 text-center">
        <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-brand/30 bg-brand/5 backdrop-blur-sm mb-8 animate-float">
          ...
          <span className="text-brand-neon text-xs font-bold tracking-widest uppercase">Expertise Certifiée 2025</span>
        </div>
        
        <h1 className="font-display text-5xl md:text-7xl lg:text-8xl leading-tight mb-6">
          RÉNOV ROUTE<br />
          <span className="text-transparent bg-clip-text bg-gradient-to-r from-white via-brand-light to-brand-dark">EXPERT EN MARQUAGE ROUTIER & SIGNALISATION À LYON ET EN RHÔNE-ALPES</span>
        </h1>
        
        <p className="font-sans text-xl md:text-2xl text-gray-400 max-w-3xl mx-auto mb-10 font-light leading-relaxed">
          <span className="text-brand font-medium">Particuliers, Entreprises, Copropriétés & Collectivités.</span><br />
          Une expertise de plus de 10 ans au service de votre sécurité et accessibilité.
        </p>
