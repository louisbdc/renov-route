    ...
    <nav className="fixed top-6 left-1/2 -translate-x-1/2 w-[95%] max-w-7xl z-50 nav-glass transition-all duration-300 rounded-full px-4">
      <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center space-x-8 text-sm font-semibold tracking-wide text-gray-300">
          ...
          <a href="#expertise" className="hover:text-brand-neon transition-colors">EXPERTISE</a>
          <a href="#realisations" className="hover:text-brand-neon transition-colors">RÉALISATIONS</a>
          <Link href="/qui-sommes-nous" className="hover:text-brand-neon transition-colors">QUI SOMMES-NOUS</Link>
          <a href="#contact" className="px-6 py-2.5 bg-brand text-white font-bold rounded-full hover:bg-brand-light hover:shadow-neon transition-all duration-300 transform hover:-translate-y-0.5">
            DEMANDER UN DEVIS
          </a>
        </div>
        <button 
