      ...
      <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-16 items-center">
        ...
        <div className="order-1 lg:order-2">
          ...
          <p className="text-xl text-gray-300 mb-8 font-light">
            Nous sommes équipés pour intervenir sur tout type de chantier, du marquage urbain aux grands parkings privés. 
            Basés à Lyon, nous intervenons dans toute la France.
          </p>
